...
cp %{_builddir}/WWW-Form-UrlEncoded-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-WWW-Form-UrlEncoded/220fe941787679d8a043c0444548ac186c86f309 || :
if test -f Makefile.PL; then
